...
class NonCompositeDataClass_Builder: Builder<NonCompositeDataClass> {
    ...
    var opionalWithDefault: String? by BuilderElementProperty({ "default" }, true)
    ...
    override fun build(): NonCompositeDataClass {
        return NonCompositeDataClass(
                ...
                opionalWithDefault = opionalWithDefault,
        )
    }
}
...
fun KClass<NonCompositeDataClass>.build(builder: NonCompositeDataClass_Builder.() -> Unit): NonCompositeDataClass {
